...
class ServiceProdTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSetRoute()
    {
        ...
        //Cache file name
        $this->assertEquals(
                $this->service->getCacheFileName(), md5(current(explode('\\', $this->routeMatch->getParam('controller'))) . $this->routeMatch->getParam('controller') . \AssetsBundle\Service\ServiceOptions::NO_ACTION)
        );
    }
    ...
    public function testRenderSimpleAssets()
    {
        ...
        //Cache file name
        $this->assertEquals(
                $sCacheName = $this->service->getCacheFileName(), md5(current(explode('\\', $this->routeMatch->getParam('controller'))) . $this->routeMatch->getParam('controller') . \AssetsBundle\Service\ServiceOptions::NO_ACTION)
        );
    ...
    public function testRenderTestAssetsFromUrl()
    {
        ...
        //Test Cache file name
        $this->assertEquals(
                $this->service->getCacheFileName(), md5(current(explode('\\', $this->routeMatch->getParam('controller'))) . $this->routeMatch->getParam('controller') . $this->service->getOptions()->getActionName())
        );
