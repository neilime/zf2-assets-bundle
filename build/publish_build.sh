...
NEW=`curl -H 'Cache-Control: no-cache' -s https://github.com/neilime/zf2-assets-bundle/blob/master/README.md | sed -n "/<article class=\"markdown-body entry-content\" itemprop=\"text\">/,/<\/article>/p"`;
